...
export default function Skills() {
    ...
    return (
        <section id="skills" className="mb-16 pt-10 ">
            <h2 className="text-2xl font-bold mb-4">
                Skills
            </h2>
            <div className="flex gap-8 p-2 border-b-2 pb-2 font-semibold text-gray-500">
                <h3
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 pt-3">
                {displayedSkills.map((skill, index) => (
                    <div key={index}
                        className="p-4 rounded-lg shadow-m gap-6 flex bg-gray-100 border border-gray-200 items-center justify-center h-[42px] w-[225px] lg:h-[52px] lg:w-[275px] xl:h-[62px] xl:w-[300px] sm:w-1/2 md:w-1/3">
                        {skill.icon}
